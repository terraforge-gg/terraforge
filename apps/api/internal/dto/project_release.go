...
type ProjectReleaseResponse struct {
	...
	Dependencies  []ProjectReleaseDependencyResponse `json:"dependencies,omitempty"`
}
...
func MapToProjectReleaseResponse(v models.ProjectRelease, skipDependencyMap bool) ProjectReleaseResponse {
